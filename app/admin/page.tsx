    ...
    <div style={{ background: "#0f172a", minHeight: "100vh", color: "#f8fafc", padding: "40px 20px", fontFamily: "sans-serif" }}>
      {!isAuthenticated ? (
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          {/* 1. TABEL DAFTAR PRODUK DI FIRESTORE */}
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: "0.85rem" }}>
                  <thead>
                    <tr style={{ borderBottom: "1px solid #334155", color: "#94a3b8" }}>
                      ...
                      <th style={{ padding: "10px" }}>Detail File/URL</th>
                    </tr>
                  </thead>
                  <tbody>
                    {products.map((p) => (
                      <tr key={p.id} style={{ borderBottom: "1px solid #0f172a" }}>
                        ...
                        <td style={{ padding: "10px", color: "#cbd5e1" }}>
                          ...
                          {p.licenseMode === "MANUAL" && Array.isArray(p.manualKeys) && (
                            <span style={{ display: "block", fontSize: "0.75rem", color: "#10b981" }}>Sisa Stok: {p.manualKeys.length}</span>
                          )}
                        </td>
                        <td style={{ padding: "10px", color: "#64748b", fontFamily: "monospace", fontSize: "0.75rem" }}>
                          {p.type === "ACCESS" ? (p.appUrl || "-") : (p.telegramFileId ? `${p.telegramFileId.substring(0, 15)}...` : "Tidak Ada File")}
                        </td>
                      </tr>
                    ))}
                  </tbody>
          ...
          <div style={{ background: "#1e293b", padding: "28px", borderRadius: "16px", border: "1px solid #334155" }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                {loading ? "Mengunggah & Menyimpan..." : "Simpan Produk Ke Database"}
              </button>
            </form>
          </div>
        </div>
