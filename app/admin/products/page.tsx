...
export default function AdminProductsPage() {
  ...
  // 1. Tampilan Layar Login Admin
  if (!isAuthenticated) {
    return (
      <div style={{ background: "#0f172a", minHeight: "100vh", color: "#f8fafc", display: "flex", alignItems: "center", justifyCenter: "center", padding: "20px", fontFamily: "sans-serif" }}>
        <div style={{ maxWidth: "400px", width: "100%", margin: "0 auto", background: "#1e293b", padding: "32px", borderRadius: "16px", border: "1px solid #334155", textAlign: "center" }}>
  ...
  // 2. Tampilan Form Management Produk
  return (
    <div style={{ background: "#0f172a", minHeight: "100vh", color: "#f8fafc", padding: "40px 20px", fontFamily: "sans-serif" }}>
      <div style={{ maxWidth: "650px", margin: "0 auto", background: "#1e293b", padding: "32px", borderRadius: "16px", border: "1px solid #334155" }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Pilihan Mode Lisensi (Jika hasLicense true) */}
          {hasLicense && (
